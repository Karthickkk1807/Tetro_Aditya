...
namespace TetroONE.Controllers
{
    public class CommonController : BaseController
    {
        ...
        [HttpPost]
        public IActionResult GetAdvancelimit([FromBody] GetAdvanceLimit request)
        {
            request.LoginUserId = Convert.ToInt32(User.Claims.FirstOrDefault(c => c.Type == ClaimTypes.NameIdentifier).Value);
             
            response = GenericTetroONE.GetData(_connectionString, "[dbo].[USP_GetAdvanceLimitDetails]", request);
