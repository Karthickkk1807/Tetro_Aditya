...
namespace TetroONE.Models
{
	public class PDFSaleReturn
	{
		...
		//public byte[] SaleReturnPrint(SaleReturnPrint data, int numberOfCopies)
		//{
		...
		//					ModuleTable.AddCell(new Cell().SetBorder(Border.NO_BORDER).SetPaddingTop(5).Add(new Paragraph("Sale Return").SetFont(kabrioBoldFont).SetFontSize(15).SetTextAlignment(TextAlignment.CENTER).SetMarginTop(-5)));
		...
		//					if (!string.IsNullOrEmpty(data.SaleReturnNumber))
		//					{
		//						GstNumberTable.AddCell(new Cell().SetBorder(Border.NO_BORDER).Add(new Paragraph("SaleReturn No").SetFont(kabrioBoldFont).SetFontSize(9).SetTextAlignment(TextAlignment.LEFT)));
		//						GstNumberTable.AddCell(new Cell().SetBorder(Border.NO_BORDER).Add(new Paragraph().Add(new Text(": ").SetFont(kabrioBoldFont)).Add(new Text(data.SaleReturnNumber).SetFont(kabrioFont)).SetFontSize(9).SetTextAlignment(TextAlignment.LEFT)));
		//					}

		//					if (!string.IsNullOrEmpty(data.SaleReturnDate))
		//					{
		//						GstNumberTable.AddCell(new Cell().SetBorder(Border.NO_BORDER).Add(new Paragraph("SaleReturn Date").SetFont(kabrioBoldFont).SetFontSize(9).SetTextAlignment(TextAlignment.LEFT)));
		//						GstNumberTable.AddCell(new Cell().SetBorder(Border.NO_BORDER).Add(new Paragraph().Add(new Text(": ").SetFont(kabrioBoldFont)).Add(new Text(data.SaleReturnDate).SetFont(kabrioFont)).SetFontSize(9).SetTextAlignment(TextAlignment.LEFT)));
		//					}
		...
		//					for (int i = 5; i < data.ProductTable.Columns.Count; i++)
		//					{
