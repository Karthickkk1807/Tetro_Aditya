$(document).ready(function () {
    // Handle CC label click
    $('#ccLabel').click(function () {
        // Hide CC label and BCC label from 'To' input
        $('#ccLabel').hide();
        $('#bccLabel').hide();

        // Show CC input field and BCC label in the CC input field
        $('#ccField').show();
    });

    // Handle BCC label click in CC input field
    $('#bccFieldLabelnew').click(function () {
        // Hide CC input field and show BCC input field
        $('#ccField').show();
        $('#bccField').show();

        // Hide BCC label after clicking BCC
        $('#bccFieldLabelnew').hide();
    });


});

/* CC BCC field Hide Show Function */

/* summernote add design above header */

$(document).ready(function () { $(".summernote").summernote({ height: 125, minHeight: null, maxHeight: null, focus: !1 }) });
    ...
    return (() => {
        ...
        return (() => {
                            ...
                            if (a[s]) {
                                ...
                                switch (a[s].action) {
                                    ...
                                    case Rt.resultAction.SubtractSpanCount:
                                        u && (d > 2 ? (d--, l.setAttribute("rowSpan", d), c.rowIndex !== r && l.cellIndex === i && (l.innerHTML = "")) : 2 === d && (l.removeAttribute("rowSpan"),
                ...
                return n = t, (o = [{
                    ...
                    value: function () {
                        var t = this.options.dialogsInBody ? this.$body : this.options.container,
                            ...
                            o = '<input type="button" href="#" class="'.concat("btn btn-primary note-btn note-btn-primary LinkButton note-link-btn", '" value="').concat(this.lang.link.insert, '" disabled>');
                ...
                return n = t, (o = [{
                    ...
                    value: function () {
                        ...
                        var o = this.options.dialogsInBody ? this.$body : this.options.container,
                            i = ['<div class="form-group note-form-group note-group-select-from-files">', '<label for="note-dialog-image-file-' + this.options.id + '" class="note-form-label">' + this.lang.image.selectFromFiles + "</label>", '<input id="note-dialog-image-file-' + this.options.id + '" class="note-image-input form-control-file note-form-control note-input" ', ' type="file" name="files" accept="' + this.options.acceptImageFileTypes + '" multiple="multiple"/>', t, "</div>", '<div class="form-group note-group-image-url">',
                                '<label for="note-dialog-image-url-' + this.options.id + '" class="note-form-label">' + this.lang.image.url + "</label>", '<input id="note-dialog-image-url-' + this.options.id + '" class="note-image-url form-control note-form-control note-input" type="text"/>', "</div>"
                            ].join(""),
            ...
            e().summernote = e().extend(e().summernote, {
                ...
                options: {
                    ...
                    icons: {
                        ...
                        code: "fa fa-code",
                        eraser: "fa fa-eraser",
                        floatLeft: "fa fa-float-left",
                        floatRight: "fa fa-float-right",
                        font: "fa fa-font",
                        frame: "fa fa-frame",
                        italic: "fa fa-italic",
                        link: "fa fa-link",
            ...
            var Re = Ne('<div class="note-editor note-frame card"></div>'),
                ...
                He = Ne(['<output class="note-status-output" role="status" aria-live="polite"></output>', '<div class="note-statusbar" role="status">', '<div class="note-resizebar" aria-label="Resize">', '<div class="fa fa-bar"></div>', '<div class="fa fa-bar"></div>', '<div class="fa fa-bar"></div>', "</div>", "</div>"].join("")),
                ...
                We = Ne('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"></div>', (function (t, e) {
                    e.fade && t.addClass("fade"), t.attr({
                        "aria-label": e.title
                    }), t.html(['<div class="modal-dialog modal-dialog-centered">', '<div class="modal-content" id="insertmodal">', e.title ? '<div class="modal-header"><h4 class="modal-title">' + e.title + '</h4><button type="button" class="close" id="closenew" data-dismiss="modal" aria-label="Close" aria-hidden="true">×</button></div>' : "", '<div class="modal-body">' + e.body + "</div>", e.footer ? '<div class="modal-footer">' + e.footer + "</div>" : "", "</div>", "</div>"].join(""))
                })),
